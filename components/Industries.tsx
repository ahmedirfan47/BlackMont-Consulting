...
import { Truck, Package, Coffee, ShoppingBag, Factory, Warehouse, Building2, Rocket } from 'lucide-react'
...
export default function Industries() {
  return (
    <section id="industries" className="section" style={{ background: '#F4FAF6' }}>
      <div className="wrap">
        {/* Header */}
        <motion.div
        ...
        >
          <span className="section-label-serif">Industries We Serve</span>
          ...
          <p style={{ fontSize: '16px', color: '#6B7C74', maxWidth: '500px', lineHeight: 1.72 }}>
            Specialized knowledge across eight key sectors in Pakistan and the GCC,
            combining operational insight with cross-industry innovation.
          </p>
        </motion.div>

        {/* Grid */}
        <div style={{ display: 'grid', gap: '14px' }} className="grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          {INDUSTRIES.map((ind, i) => {
            ...
            return (
              <motion.div
                ...
                style={{ padding: '26px 22px', background: '#FFFFFF' }}
              >
        ...
        >
          <div>
            ...
            <div style={{ fontSize: '13.5px', color: '#6B7C74' }}>
              Currently operating in Pakistan with active expansion into Saudi Arabia,
              UAE, Qatar, Bahrain, Kuwait, and Oman.
            </div>
          </div>
