    ...
    <>
      ...
      <div
        style={{
          ...
          right: 0,
          height: '2px',
          background: 'linear-gradient(90deg, #0A5C38 0%, #B8962E 50%, #0A5C38 100%)',
          zIndex: 51,
        }}
      />
      ...
      <motion.header
        ...
        style={{
          ...
          borderBottom: scrolled ? '1px solid #DDE8E2' : '1px solid transparent',
          boxShadow: scrolled ? '0 1px 28px rgba(10,92,56,0.07)' : 'none',
      ...
      >
        <div className="wrap">
          <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '70px' }}>
            ...
            <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
              <div
                style={{
                  ...
                  height: '38px',
                  borderRadius: '10px',
                  background: 'linear-gradient(145deg, #0A5C38 0%, #073D27 100%)',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  flexShrink: 0,
                  boxShadow: '0 3px 12px rgba(10,92,56,0.28)',
                }}
              >
                <CrescentIcon />
              </div>
            ...
            {/* Desktop Links */}
            <ul
              style={{ display: 'flex', alignItems: 'center', gap: '36px', listStyle: 'none', margin: 0, padding: 0 }}
              ...
              {NAV_LINKS.map((link) => (
                <li key={link.label}>
                  <a
                    ...
                    onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = '#6B7C74' }}
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <button
              ...
              onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.background = '#EAF5EE' }}
